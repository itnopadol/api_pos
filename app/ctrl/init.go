...
func ConnectMySql() (mydb *sqlx.DB) {
	...
	//dsn := "sa:[ibdkifu88@tcp(192.168.1.250:3306)/" + "pos" + "?parseTime=true&charset=utf8&loc=Local" //ใช้เวลาอัพขึ้น server นิมมาน
	//dsn := "it:[ibdkifu88@tcp(192.168.1.250:3306)/" + "pos" + "?parseTime=true&charset=utf8&loc=Local" //ใช้เวลาอัพขึ้น server แม่เหียะ
